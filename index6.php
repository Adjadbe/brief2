...
if (isset($_POST['valide'])){
  ...
  $typeIncendie = addslashes ($_POST["typeIncendie"]);
...
$db = "brief";
  ...
  $sql = $conn->query("INSERT INTO incendies (titre, nbrevictimes, typeIncendie, nbrenfants, nbrfemmes, nbrhommes, lieu, source, dateEvenement)
 VALUES ( '$titre', '$nbrevictimes', '$typeIncendie', '$nbrenfants', '$nbrfemmes', '$nbrhommes', '$lieu', '$source', '$dateEvenement')");
//  var_dump($sql);
                ...
                <div class="sidebar_gche">
                    <div class="menu">
                          <a href="index.php"> <div class="puce_blanche"> <p style="color:#3e3f5f; margin-left: 12px; margin-top: 10px;">01</p> </div> <div class="list-item">Accident</div></a>
                            ...
                            <hr>
                            <a href="index3.php"><div class="puce_blanche"><p style="color:#3e3f5f; margin-left: 12px; margin-top: 10px;">03</p></div> <div class="list-item">Viol</div></a>
                            <hr>
                            ...
                            <hr>
                            <a href="index6.php"> <div class="puce_verte"><p style="color:#fff; margin-left: 12px; margin-top: 10px;">06</p></div> <div class="list-item">Incendie</div></a>
                            <hr>
                    ...
                    <div class="section_centrale">
                        ...
                        <div class="formulaire">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="">
                                    <fieldset> 
                                        <legend>Type de l'incendie</legend>
                                           
                                        <input type="text" name="typeIncendie" class="engin"  placeholder="electrique, criminel, bouteille de gaz, …."required>
                                    </fieldset>
                                </div>
                                <br>
                                <div class="">
                                ...
                                <div class="">
                                    ...
                                    <div><br/>
                                        ...
                                        <div style="margin-left: 90px;"> 
                                                ...
                                                <input type="number"  name="an" class="jour" placeholder="YYYY"  max="3000" min="1800" size="5"  maxlength="4" style=" color:#000;height:25px" required>
