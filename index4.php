...
if (isset($_POST['valide'])){
  ...
  $typemeurtre = addslashes ($_POST["typemeurtre"]);
...
$db = "brief";
  ...
  $sql = $conn->query("INSERT INTO meurtres_atteintes_physiques (titre, nbrevictimes, typemeurtre, nbrenfants, nbrfemmes, nbrhommes, lieu, source, dateEvenement)
 VALUES ( '$titre', '$nbrevictimes', '$typemeurtre', '$nbrenfants', '$nbrfemmes', '$nbrhommes', '$lieu', '$source', '$dateEvenement')");
//  var_dump($sql);
                ...
                <div class="sidebar_gche">
                    <div class="menu">
                          <a href="index.php"> <div class="puce_blanche"> <p style="color:#3e3f5f; margin-left: 12px; margin-top: 10px;">01</p> </div> <div class="list-item">Accident</div></a>
                            ...
                            <hr>
                            <a href="index4.php"><div class="puce_verte"><p style="color:#fff; margin-left: 12px; margin-top: 10px;">04</p></div> <div class="list-item">Meurtre</div></a>
                            <hr>
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="">
                                    <fieldset> 
                                        ...
                                        <input type="text" name="typemeurtre" class="engin"  placeholder="bagarre,manifestation,crime passionnel,crime rituel"required>
                                    </fieldset>
                                </div>
                                <br>
                                <div class="">
