...
$db = "brief";
  ...
  $sql = $conn->query("INSERT INTO negligences_medicales (titre, nbrevictimes, types, nbrenfants, nbrfemmes, nbrhommes, lieu, source, dateEvenement)
 VALUES ( '$titre', '$nbrevictimes', '$types', '$nbrenfants', '$nbrfemmes', '$nbrhommes', '$lieu', '$source', '$dateEvenement')");
//  var_dump($sql);
                ...
                <div class="sidebar_gche">
                    <div class="menu">
                          <a href="index.php"> <div class="puce_blanche"> <p style="color:#3e3f5f; margin-left: 12px; margin-top: 10px;">01</p> </div> <div class="list-item">Accident</div></a>
                            ...
                            <hr>
                            <a href="index8.php"> <div class="puce_verte"><p style="color:#fff; margin-left: 12px; margin-top: 10px;">08</p></div> <div class="list-item">NegligeanceMedical</div></a>
                            <hr>
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="">
                                    <fieldset> 
                                        ...
                                        <input type="text" name="types" class="engin"  placeholder=" opération, mauvaise prescription, nonassistance …"required>
                                    </fieldset>
                                </div>
                                <br>
                                <div class="">
                               ...
                               <div>
                                ...
                                <!-- <marquee scrollamount="5">pour les jours et l'année utiliser les valeur:-12 et -2005 au lieu de 12 et 2005</marquee> -->
