...
if (isset($_POST['valide'])){
  ...
  $typeinondation = addslashes ($_POST["typeinondation"]);
...
$db = "brief";
  ...
  $sql = $conn->query("INSERT INTO inondations (titre, nbrevictimes, typeinondation, nbrenfants, nbrfemmes, nbrhommes, lieu, source, dateEvenement)
 VALUES ( '$titre', '$nbrevictimes', '$typeinondation', '$nbrenfants', '$nbrfemmes', '$nbrhommes', '$lieu', '$source', '$dateEvenement' )");
//  var_dump($sql);
                ...
                <div class="sidebar_gche">
                    <div class="menu">
                          <a href="index.php"> <div class="puce_blanche"> <p style="color:#3e3f5f; margin-left: 12px; margin-top: 10px;">01</p> </div> <div class="list-item">Accident</div></a>
                            ...
                            <hr>
                            <a href="index7.php"> <div class="puce_verte"><p style="color:#fff; margin-left: 12px; margin-top: 10px;">07</p></div> <div class="list-item">Inondation</div></a>
                            <hr>
                    ...
                    <div class="section_centrale">
                        ...
                        <div class="formulaire">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="">
                                    <fieldset> 
                                        <legend>Type de l'inondation</legend>
                                           
                                        <input type="text" name="typeinondation" class="engin"  placeholder="pluviale,tuyo cassé,remontée de la mer…"required>
                                    </fieldset>
                                </div>
                                <br>
                                <div class="">
                               ...
                               <div>
                                ...
                                <div class="">
                                    <label>Date de l'inondation: </label>
                                    <div><br/>
