...
if (isset($_POST['valide'])){
  ...
  $engins = addslashes ($_POST["engins"]);
...
$db = "brief";
  ...
  $sql = $conn->query("INSERT INTO accidents (titre, nbrevictimes, engins, nbrenfants, nbrfemmes, nbrhommes, lieu, source, dateEvenement)
 VALUES ( '$titre', '$nbrevictimes', '$engins', '$nbrenfants', '$nbrfemmes', '$nbrhommes', '$lieu', '$source', '$dateEvenement')");
// var_dump($sql);
        ...
        <div class="secondaire"> <!-- fond degrade -->
            <div class="trois">
                <div class="sidebar_gche">
                    <div class="menu">
                          <a href="index.php"> <div class="puce_verte"> <p style="color:#fff; margin-left: 12px; margin-top: 10px;">01</p> </div> <div class="list-item">Accident</div></a>
                            <hr>
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="">
                                    <fieldset> 
                                        ...
                                        <input type="text" name="engins" class="engin" id="engin"  placeholder="vehicule de transport, moto..."required>
                                    </fieldset>
                                </div>
                                <br>
                                <div class="">
                               ...
                               <div>
                                <fieldset>
                                    ...
                                    <input type="url" name="source"  id="source" placeholder="lien de publication d'article" required>
                                </fieldset>
                              </div><br/>
