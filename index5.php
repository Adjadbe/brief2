...
if (isset($_POST['valide'])){
  ...
  $typesuicide = addslashes ($_POST["typesuicide"]);
...
$db = "brief";
  ...
  $sql = $conn->query("INSERT INTO suicides (titre, nbrevictimes, typesuicide, nbrenfants, nbrfemmes, nbrhommes, lieu, source, dateEvenement)
 VALUES ( '$titre', '$nbrevictimes', '$typesuicide', '$nbrenfants', '$nbrfemmes', '$nbrhommes', '$lieu', '$source', '$dateEvenement')");
//  var_dump($sql);
                ...
                <div class="sidebar_gche">
                    <div class="menu">
                          <a href="index.php"> <div class="puce_blanche"> <p style="color:#3e3f5f; margin-left: 12px; margin-top: 10px;">01</p> </div> <div class="list-item">Accident</div></a>
                            ...
                            <hr>
                            <a href="index5.php"> <div class="puce_verte"><p style="color:#fff; margin-left: 12px; margin-top: 10px;">05</p></div> <div class="list-item">Suicide</div></a>
                            <hr>
                    ...
                    <div class="section_centrale">
                        ...
                        <div class="formulaire">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="">
                                    <fieldset> 
                                        <legend>Type du suicide</legend>
                                           
                                        <input type="text" name="typesuicide" class="engin"  placeholder="inconnu, chagrin, depression …."required>
                                    </fieldset>
                                </div>
                                <br>
                                <div class="">
