...
if (isset($_POST['valide'])){
  ...
  $typevol = addslashes ($_POST["typevol"]);
...
$db = "brief";
  ...
  $sql = $conn->query("INSERT INTO vols (titre, nbrevictimes, typevol, nbrenfants, nbrfemmes, nbrhommes, lieu, source, dateEvenement)
 VALUES ( '$titre', '$nbrevictimes', '$typevol', '$nbrenfants', '$nbrfemmes', '$nbrhommes', '$lieu', '$source', '$dateEvenement')");
//  var_dump($sql);
                ...
                <div class="sidebar_gche">
                    <div class="menu">
                          <a href="index.php"> <div class="puce_blanche"> <p style="color:#3e3f5f; margin-left: 12px; margin-top: 10px;">01</p> </div> <div class="list-item">Accident</div></a>
                            <hr>
                            <a href="index2.php"><div class="puce_verte"><p style="color:#fff; margin-left: 12px; margin-top: 10px;">02</p></div> <div class="list-item">Vol</div></a>
                            <hr>
                    ...
                    <div class="section_centrale">
                        ...
                        <div class="formulaire">
                            ...
                            <form action="" method="POST">
                                ...
                                <div id="oui" style="margin-left: 190px;">
                                    <fieldset id="oui"> 
                                ...
                                <div class="">
                                    <fieldset> 
                                        <legend>Type du vol</legend>
                                           
                                        <input type="text" name="typevol" class="engin"  placeholder="braquage,depouillement,vol à l'arrache..."required>
                                    </fieldset>
                                </div>
                                <br>
                                <div class="">
